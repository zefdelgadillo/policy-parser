...
@pytest.fixture
def sample_policy():
    f = open(os.path.join(os.path.dirname(__file__), 'fixtures/policy-fixture.yaml'), "r")
...
def test_binding_member_member(sample_binding):
    assert sample_binding.members[0].member == 'serviceAccount:555555555555@cloudbuild.gserviceaccount.com'
...
def test_binding_member_principal(sample_binding):
    assert sample_binding.members[0].principal == '555555555555@cloudbuild.gserviceaccount.com'
